...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="page-title mb-1">Daftar Tindakan</h2>
            <p class="text-secondary m-0" style="font-size: 0.9rem;">Manajemen aktivitas dan tindakan hukum forensik</p>
        </div>
        
        <a href="{{ route('tindakan.create') }}" class="btn btn-glow rounded-pill d-flex align-items-center gap-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                <div class="rounded-circle d-flex align-items-center justify-content-center" 
                                    ...
                                    <i class="ph-duotone ph-gavel" style="font-size: 20px; color: #cbd5e1;"></i>
                                </div>
                                <div>
                                    <span class="d-block fw-bold text-white">{{ $td->judul_tindakan }}</span>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2 text-gray-300">
                                <i class="ph-duotone ph-user-circle text-secondary"></i>
                                {{ $td->petugas }}
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="d-flex flex-column">
                                <span class="text-white" style="font-size: 0.9rem;">
                                    {{ \Carbon\Carbon::parse($td->waktu_tindakan)->format('d M Y') }}
                                </span>
                                <span class="text-secondary" style="font-size: 0.8rem;">
                                    {{ \Carbon\Carbon::parse($td->waktu_tindakan)->format('H:i') }} WIB
                                </span>
                            </div>
                        </td>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="{{ route('tindakan.edit', $td->id) }}" 
                                   class="btn-action btn-edit" 
                                   title="Edit Data">
                                    <i class="ph-bold ph-pencil-simple"></i>
                                </a>

                                <form action="{{ route('tindakan.destroy', $td->id) }}" 
                                      method="POST" 
                                      class="d-inline"
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-5">
                            <div class="d-flex flex-column align-items-center">
                                <i class="ph-duotone ph-clipboard-text text-secondary mb-3" style="font-size: 48px; opacity: 0.5;"></i>
                                <h5 class="text-white">Belum ada tindakan</h5>
                                <p class="text-secondary mb-0">Silakan tambahkan data tindakan baru.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
