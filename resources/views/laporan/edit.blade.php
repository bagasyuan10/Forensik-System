...
<style>
    /* --- BACKGROUND DECORATION (SAME AS KASUS) --- */
    .bg-blob-form {
    ...
    <div class="d-flex justify-content-between align-items-end mb-4 animate__animated animate__fadeInDown">
        <div>
            <div class="d-flex align-items-center gap-2 mb-1">
                <h2 class="fw-bold text-white mb-0">Edit Pengaduan Masyarakat</h2>
                <span class="badge-edit-mode"><i class="ph-fill ph-pencil-simple me-1"></i> Mode Edit</span>
            </div>
            <p class="text-secondary m-0">Perbarui detail aduan atau laporan dari warga.</p>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xl-9">
            <div class="form-card p-4 p-md-5 animate__animated animate__fadeInUp animate__delay-1s">
                ...
                {{-- Form Action --}}
                <form id="editLaporanForm" action="{{ route('laporan.update', $laporan->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    {{-- SECTION 1: IDENTITAS ADUAN --}}
                    <div class="section-divider mt-0">
                        <i class="ph-duotone ph-megaphone text-warning fs-5"></i>
                    ...
                    <div class="row g-4">
                        {{-- Judul Aduan --}}
                        <div class="col-12">
                            <label class="form-label-glow">Perihal / Judul Aduan</label>
                            <div class="input-group">
                                <span class="input-group-text input-group-text-glass"><i class="ph-bold ph-megaphone"></i></span>
                                <input type="text" name="judul_laporan" class="form-control form-control-glass" 
                                       value="{{ old('judul_laporan', $laporan->judul_laporan) }}" required
                                       placeholder="Contoh: Keributan di Desa X...">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text input-group-text-glass"><i class="ph-bold ph-calendar-plus"></i></span>
                                <input type="date" name="tanggal_laporan" class="form-control form-control-glass"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="penyusun" class="form-control form-control-glass" 
                                       value="{{ old('penyusun', $laporan->penyusun) }}"
                                       placeholder="Nama warga pelapor...">
                            </div>
                        </div>
                    </div>

                    {{-- SECTION 2: DETAIL KRONOLOGI --}}
                    <div class="section-divider">
                        <i class="ph-duotone ph-article text-warning fs-5"></i>
                        <span class="section-title">Detail Kronologi</span>
                        <div class="section-line"></div>
                    </div>

                    <div class="row g-4">
                        <div class="col-12">
                            <label class="form-label-glow">Isi Laporan / Kronologi Lengkap</label>
                            <textarea name="isi_laporan" class="form-control form-control-glass standalone-input" 
                                      rows="10" required placeholder="Jelaskan detail kejadian...">{{ old('isi_laporan', $laporan->isi_laporan) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-5 pt-3 border-top border-secondary border-opacity-10">
                        {{-- Tombol Batal --}}
                        <a href="{{ route('laporan.index') }}" class="btn btn-glass-cancel">
...
<script>
    function confirmUpdate() {
        ...
        // Cek validasi HTML5 bawaan dulu
        ...
        Swal.fire({
            ...
            text: "Detail pengaduan ini akan diperbarui.",
            icon: 'warning',
